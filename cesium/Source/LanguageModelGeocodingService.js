...
/**
 * Provides geocoding via a language model server.
 * @alias LanguageModelGeocoderService
 * @constructor
 *
 ...
 *   geocoder: new Cesium.LanguageModelGeocoderService(new Cesium.Resource({
 ...
 * });
 */
function LanguageModelGeocoderService(url) {
...
Object.defineProperties(LanguageModelGeocoderService.prototype, {
  /**
   * The Resource used to access the Pelias endpoint.
   * @type {Resource}
   * @memberof LanguageModelGeocoderService.prototype
   * @readonly
   */
  url: {
    get: function () {
 ...
 */
LanguageModelGeocoderService.prototype.geocode = function (query, type) {
  //>>includeStart('debug', pragmas.debug);
...
export default LanguageModelGeocoderService;
